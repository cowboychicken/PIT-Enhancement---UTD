...
public enum NewMathMutator implements MethodMutatorFactory {
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo,
        ...
        return new MathVisitor(this, context, methodVisitor);
    }
...
class MathVisitor extends MethodVisitor {
    ...
    MathVisitor(final MethodMutatorFactory factory, final MutationContext context,
