...
public enum RelationalOperatorReplacementMutator7 implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo,
    ...
    return new RelationalOperatorMethodVisitor7(this, context, methodVisitor);
  }
...
class RelationalOperatorMethodVisitor7 extends AbstractJumpMutator {
  ...
  static {
    ...
    MUTATIONS.put(Opcodes.IFGT, new Substitution(Opcodes.IF_ICMPLT, DESCRIPTION));
    ...
    MUTATIONS.put(Opcodes.IF_ICMPLE, new Substitution(Opcodes.IFGE, DESCRIPTION));
  ...
  RelationalOperatorMethodVisitor7(final MethodMutatorFactory factory, final MutationContext context,
