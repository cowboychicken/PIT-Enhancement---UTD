...
public enum RelationalOperatorReplacementMutator1 implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo,
    ...
    return new RelationalOperatorMethodVisitor1(this, context, methodVisitor);
  }
...
class RelationalOperatorMethodVisitor1 extends AbstractJumpMutator {
  ...
  static {
    ...
    MUTATIONS.put(Opcodes.IFGE, new Substitution(Opcodes.IF_ICMPLE, DESCRIPTION));
    ...
    MUTATIONS.put(Opcodes.IF_ICMPLT, new Substitution(Opcodes.IFGT, DESCRIPTION));

  }

  RelationalOperatorMethodVisitor1(final MethodMutatorFactory factory, final MutationContext context,
